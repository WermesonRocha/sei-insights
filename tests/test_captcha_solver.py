...
class CaptchaSolverTest(unittest.TestCase):
    ...
    def test_solve_captcha_in_page_sucesso_primeira_tentativa(self):
        ...
        with patch('sei_insights.clients.captcha_solver.CaptchaSolver.solve_from_base64', return_value="ABC123"):
    ...
    def test_solve_captcha_in_page_retry_apos_falha(self):
        ...
        with patch('sei_insights.clients.captcha_solver.CaptchaSolver.solve_from_base64', side_effect=["ABC", "XYZ789"]):
            solver = CaptchaSolver(max_retries=3)
            result = solver.solve_captcha_in_page(fake_page)
    ...
    def test_solve_captcha_in_page_falha_apos_max_retries(self):
        ...
        with patch('sei_insights.clients.captcha_solver.CaptchaSolver.solve_from_base64', return_value="INVALID"):
            solver = CaptchaSolver(max_retries=3)
    ...
    def test_solve_captcha_in_page_incrementa_call_count_no_retry(self):
        ...
        with patch('sei_insights.clients.captcha_solver.CaptchaSolver.solve_from_base64', side_effect=["AB", "CD", "EF1234"]):
            solver = CaptchaSolver(max_retries=3)
            result = solver.solve_captcha_in_page(fake_page)
